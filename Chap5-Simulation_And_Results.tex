...
\end{table}
    ...
    \section{Experiments Results}
        ...
        \begin{figure}
            \centering
            \includesvg[width=\textwidth]{figs/Chap5/march9/plot_cr_w_vs_wo.svg}
...
%AMA tenta te livrar desse espaco em branco q tem nessa pagina
        ...
        \begin{figure}[H]
            \centering
%AMA nao era p ser overtaking na legenda ?
...
%AMA aqui poderia ser outra secao. Summary of results
        ...
        Regarding the minimum distance kept for the head-on encounter, in our simulations, the \ac{OV} kept from the \ac{AV} a distance at least 1.6 times bigger than Huang~\etal{}. Unfortunately, Agrawal~\etal{} do not inform any minimal distance kept. Regarding the \ac{OV} `s maximum achieved speed, our vessel achieved a maximum velocity 2.12 times slower than Huang~\etal{}`s vessel. The maximum achieved velocity is one the main limitation in our solution, since the vessel we use is capable of achieving 1.8 m/s.
...
\begin{tabular}{cccc} 
\toprule
\textbf{Comparison Parameter}           & \textbf{Jurak}                                                        & \textbf{Agrawal~\etal{}}~\cite{Agrawal2015COLREGS}                                             & \textbf{Huang~\etal{}}~\cite{Huang2019Generalized}                                         \\ 
\toprule
\textbf{Method}                         & ATC A*                                                                    & A*                                                           & VO                                                     \\ 
\cline{2-4}
\textbf{Simulator}                      & USV\_sim                                              & Matlab                                                       & Matlab                                                 \\ 
\cline{2-4}
\textbf{CPU}                            & \begin{tabular}[c]{@{}c@{}}Intel i7\\3.4 GHz \\16 GB RAM\end{tabular} & \begin{tabular}[c]{@{}c@{}}Intel i5\\2.4 GHz \\\end{tabular} & \begin{tabular}[c]{@{}c@{}}Not\\Informed\end{tabular}  \\ 
\cline{2-4}
\textbf{Search Space Dimension}         & 100x100                                                               & 100x100                                                      & N/A                                                    \\ 
\cline{2-4}
\textbf{Maximum~Computational~Time (s)} & 0.364                                                                 & 0.238                                                        & \textless{} 1                                          \\ 
\cline{2-4}
\textbf{Vessel Length (m)}              & 1.2                                                                   & 4                                                            & 1.255                                                  \\ 
\cline{2-4}
\textbf{Minimal Distance Kept (m)}      & 1.599                                                                 & \begin{tabular}[c]{@{}c@{}}Not\\Informed\end{tabular}        & 0.992                                                  \\ 
\cline{2-4}
\textbf{Own Vessel Max. Speed (m/s)}    & 0.47                                                                  & \begin{tabular}[c]{@{}c@{}}Not\\Informed\end{tabular}        & 1                                                      \\
\hline
\end{tabular}
